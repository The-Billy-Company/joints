...
///
/// Capped at 64 MiB: a grammar or a source file past that is not a file this
/// verb was built to hold in one arena, and refusing loudly here beats an
/// allocator refusing less legibly three calls further in.
