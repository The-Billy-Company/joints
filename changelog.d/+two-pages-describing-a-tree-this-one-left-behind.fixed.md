Two pages asserted a state the repo had moved past, both in the direction that
undersells it.

`CONTRIBUTING.md` opened with *there is no parser: what exists is the press*.
...
`tool/README.md` still headlined `16 whole on ALL THREE`. That number was correct
...
axis can see, whole and sound and confidently wrong - and it will separate again
the moment a row builds a file whole and builds it wrong, which `stand` and
`shape` are constitutionally unable to report.
